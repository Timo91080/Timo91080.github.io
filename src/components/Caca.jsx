...
const Caca = () => {
  ...
  return (
    ...
    <div className='  max-w-[1200px] relative left-20  mx-auto grid md:grid-cols-3 gap-8 '> 
    <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
        ...
        <button className='bg-[#a0f3d9] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>S'inscrire à la formation</button>
          ...
          <div className=" relative left-7 max-w-md mx-auto px-20">
      <h2 className="text-2xl font-bold mb-4">Formulaire d'inscription</h2>
      <form onSubmit={handleSubmit} className='px-30'>
        <div className="mb-4">
          <label htmlFor="firstName" className="block mb-2 text-sm font-medium text-gray-700">Prénom:</label>
          <input
            type="text"
            id="firstName" 
            name="firstName"
        ...
        <div className="mb-4">
          <label htmlFor="lastName" className="block mb-2 text-sm font-medium text-gray-700">Nom:</label>
          <input
            type="text"
            id="lastName"
            name="lastName"
        ...
        <div className="mb-4">
          <label htmlFor="location" className="block mb-2 text-sm font-medium text-gray-700">Lieu de résidence:</label>
          <input
            type="text"
            id="location"
            name="location"
